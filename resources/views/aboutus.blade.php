  ...
  <div class="flex p-12 mt-20 mx-20 bg-gray-100 bg-opacity-60 background-trans rounded-lg shadow-lg">
    ...
    <div class="w-full sm:w-3/4">
      ...
      <p class="text-base sm:text-xl text-gray-700 sm:ml-12 mb-4 sm:mr-6 font-myriad">
        ...
        maintain the highest quality production standards.</p>
      <p class="text-base sm:text-xl text-gray-700 sm:ml-12 mb-4 sm:mr-6 font-myriad">
        Whether you are a designer, advertising agency, local business or national corporation, our personable and
        knowledgeable staff can assist with your image, and extend your outreach to a targeted clientel.</p>
      <p class="text-base sm:text-xl text-gray-700 sm:ml-12 mb-4 sm:mr-6 font-myriad">
        Throughout the years our philosophy has remained unchanged: treat your project as our own. With an emphasis on
        service, we strive for the best quality possible, at a fair price, and timely delivery.</p>
      <p class="text-base sm:text-xl text-gray-700 sm:ml-12 mb-4 sm:mr-6 font-myriad">
        See what our clients think of us on the <span
          ...
          <a href="/testimonials"><span class="xxs:leading-loose sm:leading-normal"> Testimonials</span></a></span>
        page.</p>
      <p class="font-semibold sm:text-xl text-gray-700 text-semibold sm:ml-12 sm:mr-6 font-myriad">
