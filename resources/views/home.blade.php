  ...
  <div class="py-8">
    {{-- <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg"> --}}
        ...
        <div class="pb-2 flex">
          <div class="mx-auto sm:w-3/4 max-w-5xl p-2 mt-5 sm:mt-8 bg-gray-50 bg-opacity-50 border rounded-lg shadow-2xl">
            ...
            <div class="flex justify-between">
              <div class="block pt-2 pl-2 sm:pl-6 mb-0 text-sm sm:text-base text-gray-800 font-bold ">Hours: M-F 9am-5pm</div>
              ...
              <div
                class="pt-2 pr-2 sm: mb-0 tracking-tight sm:tracking-normal text-center sm:text-right text-sm sm:text-base text-gray-800 font-bold flex-col-2">
                The Home Office - Tampa, FL
              </div>
            </div>
